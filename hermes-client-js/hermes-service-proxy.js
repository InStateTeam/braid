...
/**
 * Provides a dynamic proxy that intercepts all method calls and forwards them to a hermes JSONRpc service
...
/**
 * Factory function to create a javascript proxy that dispatches ot a HermesServiceProxy object
...
function createProxy(url, onOpen, onClose, onError, options) {
  return new Proxy(new HermesServiceProxy(url, onOpen, onClose, onError, options), {
    get: (target, propKey) => {
