package io.bluebank.hermes.core.client
...
class HermesInvocationHandler(endpoint: ServiceEndpoint) : InvocationHandler {
...
inline fun <reified T : Any> KClass<T>.hermesProxy(endpoint: ServiceEndpoint) = hermesProxy(T::class.java, endpoint)

fun <T: Any> hermesProxy(clazz: Class<T>, endpoint: ServiceEndpoint) : T {
  val loader = clazz.classLoader
  val interfaces = arrayOf(clazz)
  val invocationHandler = HermesInvocationHandler(endpoint)
